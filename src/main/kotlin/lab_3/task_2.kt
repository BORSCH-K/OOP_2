...
fun task_2() {
    ...
    listOf(
        "//DataSet/Series/SeriesKey/Value[@concept='s_grtov'][@value='9415']" to
                { node: Node ->
                    if (node.getText("../..//Time") > "2012") {
//                        println(monthAndYearTemp)
                        when (node.getText("../..//SeriesKey/Value[@concept='s_OKATO']/@value")) {
                            "643" -> {
                                counterRF.add(node.getText("../..//Obs/ObsValue/@value"))
                                val monthAndYearTemp =
                                    node.getText("../..//Value[@concept='PERIOD']/@value") + " " + node.getText("../..//Time")
    ...
    listOf(
        "//DataSet/Series/SeriesKey/Value[@concept='s_OKATO'][@value='52401000000']" to
                { node: Node ->
                    if (node.getText("../..//Time") > "2012") {
